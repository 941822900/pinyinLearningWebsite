//资源配置
//图片
var kianaImg1 = "image/kiana-master/src/img/kiana-1.png";
var kianaImg2 = "image/kiana-master/src/img/kiana-2.png";
var kianaImg3 = "image/kiana-master/src/img/kiana-3.gif";
var kianaImg4 = "image/kiana-master/src/img/kiana-4.png";
//MP3
var dragMp3 = "image/kiana-master/src/mp3/kiana_drag.mp3";
var kiana_4Mp3 = "image/kiana-master/src/mp3/kiana_4.mp3";
var kiana_2Mp3 = "image/kiana-master/src/mp3/kiana_2.mp3";
var kiana_11Mp3 = "image/kiana-master/src/mp3/kiana_11.mp3";
var kiana_10Mp3 = "image/kiana-master/src/mp3/kiana_10.mp3";
var kiana_8Mp3 = "image/kiana-master/src/mp3/kiana_8.mp3";
//语言
var lan =
    [
        "呀~~",
...
$.fn.dragging = function (data) {
    ...
    function $thisRandom() {
        $this.each(function (index) {
            var randY,randX,cnt=0;
            randY = parseInt(Math.random() * (faHeight - thisHeight));///
            randX = parseInt(Math.random() * (faWidth - thisWidth));///
            randY=Math.min(randY,faHeight - thisHeight - 110);
            randX=Math.min(randX,faWidth - thisWidth - 110);
            randY=Math.max(randY,0);
